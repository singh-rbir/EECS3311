...
extern EIF_TYPED_VALUE F967_7313(EIF_REFERENCE);
extern EIF_TYPED_VALUE F967_7314(EIF_REFERENCE);
extern void F967_7315(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F967_7316(EIF_REFERENCE);
extern void F967_7317(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 966, Current, 1, 1, 13597);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(966, Current, 13597);
	RTCC(arg1, 966, l_feature_name, 1, eif_new_type(967, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_BOOLEAN) !(EIF_BOOLEAN)(loc1 != NULL)) {
		RTHOOK(4);
		RTDBGAL(1, 0xF800014C, 0, 0); /* loc1 */
		tr1 = RTLNSMART(RTWCT(5095, dtype, Dftype(Current)).id);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(2880, Dtype(tr1)))(tr1);
		RTNHOOK(4,1);
		loc1 = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(5);
		RTDBGAA(Current, dtype, 5095, 0xF800014C, 0); /* classes */
		tr1 = RTCCL(loc1);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(5095, dtype)) = (EIF_REFERENCE) tr1;
		RTHOOK(6);
		RTDBGAA(Current, dtype, 5094, 0xF80000E8, 0); /* name */
		...
		tr1 = RTCCL(tr2);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(5094, dtype)) = (EIF_REFERENCE) tr1;
	}
	RTHOOK(7);
	ur1 = RTCCL(arg1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 966, Current, 2, 1, 13598);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5095, "classes", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc1 = RTCCL(tr1);
	if (EIF_TEST(loc1)) {
		RTHOOK(3);
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 966, Current, 3, 1, 13599);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	ub1 = tb1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(5061, Dtype(tr1)))(tr1, ur1x, ur2x, ur3x, ub1x);
	RTNHOOK(4,1);
	loc1 = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
...
EIF_TYPED_VALUE F967_7313 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F967_7314 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 966, Current, 2, 0, 13602);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 966, Current, 0, 1, 13603);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F967_7317 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_r
	...
	RTEAA(l_feature_name, 966, Current, 0, 3, 13594);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(966, Current, 13594);
	RTCC(arg3, 966, l_feature_name, 3, RTWCT(5094, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5086, 0x04000000, 1); /* show_err */
	*(EIF_BOOLEAN *)(Current + RTWA(5086, dtype)) = (EIF_BOOLEAN) arg1;
...
EIF_TYPED_VALUE F967_7318 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(5094,Dtype(Current)));
	return r;
}
