...
static const EIF_TYPE_INDEX egt_15_972 [] = {0xFF01,232,0xFFFF};
...
static const struct desc_info desc_972[] = {
	...
	{EIF_GENERIC(egt_13_972), 13662, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_972), 13659, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_15_972), 13668, 0xFFFFFFFF},
};
void Init972(void)
{
	IDSC(desc_972, 0, 971);
	IDSC(desc_972 + 1, 1, 971);
	IDSC(desc_972 + 32, 393, 971);
	IDSC(desc_972 + 36, 399, 971);
}
