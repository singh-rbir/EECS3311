...
EIF_REFERENCE F768_5289 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	...
	RTEAA("generic_parameter_type", 767, Current, 0, 1, 11292);
...
/* {TYPE}.default */
EIF_INTEGER_16 F768_5304 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_REFERENCE F768_5316 (EIF_REFERENCE Current)
{
	...
	RTEAA("runtime_name", 767, Current, 0, 0, 11319);
