...
/* {LIST}.is_equal */
EIF_BOOLEAN F547_3451 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F331_2657(RTCW(arg1));
		if ((EIF_BOOLEAN)(F331_2657(Current) == tb2)) {
		...
		tb1 = '\0';
		if (Result) {
			tb1 = (EIF_BOOLEAN) !F331_2657(Current);
		}
		if (tb1) {
			tb1 = '\0';
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (*(EIF_BOOLEAN *)(Current + O2329[dtype-214])) {
						ti4_1 = (eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2375[dtype-571])(Current));
						ti4_2 = (eif_optimize_return = 1, *(EIF_INTEGER_32 *)(FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R2375[Dtype(RTCW(arg1))-571])(arg1));
...
/* {LIST}.after */
EIF_BOOLEAN F547_3452 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_INTEGER_32 ti4_2;
