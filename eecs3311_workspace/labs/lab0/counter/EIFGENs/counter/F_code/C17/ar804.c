...
/* {ARRAYED_LIST}.item */
EIF_BOOLEAN F597_4078 (EIF_REFERENCE Current)
{
	GTCX
	...
	tb2 = *((EIF_BOOLEAN *)RTCW(tr1) + ((EIF_INTEGER_32) (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_0_) - ((EIF_INTEGER_32) 1L))));
	/* END INLINED CODE */
	Result = tb2;
	RTLE;
	return Result;
...
/* {ARRAYED_LIST}.i_th */
EIF_BOOLEAN F597_4079 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	EIF_INTEGER_32 ti4_1;
	...
	tr1 = *(EIF_REFERENCE *)(Current);
	/* INLINED CODE (SPECIAL.item) */
	tb2 = *((EIF_BOOLEAN *)RTCW(tr1) + ((EIF_INTEGER_32) (arg1 - ((EIF_INTEGER_32) 1L))));
	/* END INLINED CODE */
	Result = tb2;
	RTLE;
	return Result;
...
/* {ARRAYED_LIST}.index */
EIF_INTEGER_32 F597_4083 (EIF_REFERENCE Current)
{
...
/* {ARRAYED_LIST}.cursor */
EIF_REFERENCE F597_4084 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	RTLD;
...
/* {ARRAYED_LIST}.count */
EIF_INTEGER_32 F597_4094 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
...
EIF_INTEGER_32 F597_4095 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	EIF_INTEGER_32 Result = ((EIF_INTEGER_32) 0);
...
/* {ARRAYED_LIST}.upper */
EIF_INTEGER_32 F597_4096 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	EIF_INTEGER_32 Result = ((EIF_INTEGER_32) 0);
...
EIF_BOOLEAN F597_4097 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	if ((EIF_BOOLEAN)(arg1 == Current)) {
		...
		tb1 = '\0';
		ti4_1 = F597_4094(RTCW(arg1));
		if ((EIF_BOOLEAN)(F597_4094(Current) == ti4_1)) {
			...
			if (*(EIF_BOOLEAN *)(Current+ _CHROFF_1_0_)) {
				...
				for (;;) {
					...
					if (!(EIF_BOOLEAN) !Result) {
						tb1 = (EIF_BOOLEAN) (loc1 > F597_4096(Current));
					}
					if (tb1) break;
					Result = F597_4079(Current, loc1);
					tb2 = F597_4079(RTCW(arg1), loc1);
				...
				ti4_1 = F597_4094(Current);
				Result = F478_3218(RTCW(tr1), tr2, ((EIF_INTEGER_32) 0L), ((EIF_INTEGER_32) 0L), ti4_1);
			}
		}
	}
	RTLE;
...
EIF_BOOLEAN F597_4100 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
...
/* {ARRAYED_LIST}.start */
void F597_4104 (EIF_REFERENCE Current)
{
	GTCX
...
/* {ARRAYED_LIST}.forth */
void F597_4106 (EIF_REFERENCE Current)
{
	GTCX
...
/* {ARRAYED_LIST}.go_to */
void F597_4109 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
...
/* {ARRAYED_LIST}.copy */
void F597_4124 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	RTLD;
	...
	if ((EIF_BOOLEAN)(arg1 != Current)) {
		...
		tr1 = F1_14(tr1);
		F184_2412(Current, tr1);
	}
	RTLE;
}

/* {ARRAYED_LIST}.correct_mismatch */
void F597_4133 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	if (tb1) {
		tr1 = RTLNSP2(eif_final_id(Y2156,Y2156_gen_type,dftype,171).id,0,loc3,sizeof(EIF_BOOLEAN), EIF_TRUE);
