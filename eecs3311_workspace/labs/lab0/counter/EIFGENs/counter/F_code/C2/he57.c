...
void F44_1269 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTGC;
	F44_1274(Current, ((EIF_INTEGER_32) 0L));
	tr1 = RTLNSMART(eif_new_type(873, 1).id);
	tr2 = RTMS_EX_H(" ",1,32);
	F872_6607(RTCW(tr1), tr2);
	RTAR(Current, tr1);
...
EIF_BOOLEAN F44_1271 (EIF_REFERENCE Current)
{
	GTCX
...
void F44_1274 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTLD;
...
void F44_1275 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	...
	RTGC;
	F44_1274(Current, arg2);
	loc1 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	loc4 = (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R4681[Dtype(RTCW(arg1))-873])(arg1);
	loc7 = arg1;
	loc7 = RTRV(eif_new_type(871, 0x01),loc7);
	if (EIF_TEST(loc7)) {
		...
		for (;;) {
			...
			/* END INLINED CODE */
			tc1 = tc2;
			F44_1276(Current, tc1);
			loc1++;
		}
	} else {
		loc8 = arg1;
		loc8 = RTRV(eif_new_type(874, 0x01),loc8);
		if (EIF_TEST(loc8)) {
...
void F44_1276 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1)
{
	GTCX
			...
			case 0L:
				if ((EIF_BOOLEAN) (((EIF_BOOLEAN) ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '0') && (EIF_BOOLEAN) ((EIF_BOOLEAN)(*(EIF_CHARACTER_8 *)(Current+ _CHROFF_2_0_) == (EIF_CHARACTER_8) 'x') || (EIF_BOOLEAN)(*(EIF_CHARACTER_8 *)(Current+ _CHROFF_2_0_) == (EIF_CHARACTER_8) 'X')))) || (EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '&'))) {
					...
					if ((EIF_BOOLEAN) ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '-') || (EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '+'))) {
						...
						tr1 = RTLNS(eif_new_type(801, 0x00).id, 801, _OBJSIZ_0_1_0_0_0_0_0_0_);
						*(EIF_CHARACTER_8 *)tr1 = arg1;
						tb1 = F800_5607(RTCW(tr1));
						if (tb1) {
				...
				if (tb1) {
					*(EIF_NATURAL_64 *)(Current+ _I64OFF_2_4_0_3_0_0_0_) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_INTEGER_32) 0L);
					...
					if ((EIF_BOOLEAN)(*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_4_0_0_) != ((EIF_INTEGER_32) 0L))) {
						tr1 = RTOUCR(18,F44_1292, (Current));
						tb2 = F42_1245(RTCW(tr1), *(EIF_NATURAL_64 *)(Current+ _I64OFF_2_4_0_3_0_0_0_), *(EIF_NATURAL_64 *)(Current+ _I64OFF_2_4_0_3_0_0_1_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_4_0_0_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_4_0_2_));
						tb1 = tb2;
					}
					if (tb1) {
				...
				*(EIF_CHARACTER_8 *)tr1 = arg1;
				...
				if (tb1) {
					...
					*(EIF_NATURAL_64 *)(Current+ _I64OFF_2_4_0_3_0_0_0_) = (EIF_NATURAL_64) (EIF_NATURAL_64) ((EIF_NATURAL_64) (*(EIF_NATURAL_64 *)(Current+ _I64OFF_2_4_0_3_0_0_0_) * (EIF_NATURAL_64) ((EIF_INTEGER_32) 16L)) + *(EIF_NATURAL_64 *)(Current+ _I64OFF_2_4_0_3_0_0_1_));
					...
					if ((EIF_BOOLEAN)(*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_4_0_0_) != ((EIF_INTEGER_32) 0L))) {
						tr1 = RTOUCR(18,F44_1292, (Current));
						tb1 = F42_1245(RTCW(tr1), *(EIF_NATURAL_64 *)(Current+ _I64OFF_2_4_0_3_0_0_0_), *(EIF_NATURAL_64 *)(Current+ _I64OFF_2_4_0_3_0_0_1_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_4_0_0_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_4_0_2_));
...
EIF_BOOLEAN F44_1279 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
...
EIF_NATURAL_32 F44_1287 (EIF_REFERENCE Current)
{
	GTCX
	EIF_NATURAL_64 tu8_1;
...
static EIF_REFERENCE F44_1292_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
#define Result RTOTRR
	...
	RTGC;
	RTOTP;
	tr1 = RTLNS(eif_new_type(41, 0x01).id, 41, _OBJSIZ_4_0_0_0_0_0_0_0_);
	F42_1244(RTCW(tr1));
...
EIF_REFERENCE F44_1292 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(18,F44_1292_body,(Current));
}
