...
EIF_BOOLEAN F674_4360 (EIF_REFERENCE Current)
{
	GTCX
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		RTLE;
		return (EIF_BOOLEAN) F659_4343(Current);
	} else {
		Result = '\01';
...
void F674_4362 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_REFERENCE F674_4363 (EIF_REFERENCE Current)
{
