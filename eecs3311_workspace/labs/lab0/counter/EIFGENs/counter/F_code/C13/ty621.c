...
/* {TYPE}.name */
EIF_REFERENCE F760_5288 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_REFERENCE F760_5289 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("generic_parameter_type", 759, Current, 0, 1, 11142);
...
/* {TYPE}.type_id */
EIF_INTEGER_32 F760_5290 (EIF_REFERENCE Current)
{
	GTCX
...
/* {TYPE}.hash_code */
EIF_INTEGER_32 F760_5291 (EIF_REFERENCE Current)
{
	GTCX
...
/* {TYPE}.is_attached */
EIF_BOOLEAN F760_5296 (EIF_REFERENCE Current)
{
	GTCX
...
/* {TYPE}.is_equal */
EIF_BOOLEAN F760_5297 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
...
/* {TYPE}.default */
EIF_NATURAL_16 F760_5304 (EIF_REFERENCE Current)
{
	GTCX
...
/* {TYPE}.out */
EIF_REFERENCE F760_5305 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
...
/* {TYPE}.runtime_name */
EIF_REFERENCE F760_5316 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("runtime_name", 759, Current, 0, 0, 11169);
