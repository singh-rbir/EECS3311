...
/* {TYPE}.name */
EIF_REFERENCE F748_5288 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_REFERENCE F748_5289 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("generic_parameter_type", 747, Current, 0, 1, 10122);
...
/* {TYPE}.type_id */
EIF_INTEGER_32 F748_5290 (EIF_REFERENCE Current)
{
	GTCX
...
/* {TYPE}.hash_code */
EIF_INTEGER_32 F748_5291 (EIF_REFERENCE Current)
{
	GTCX
...
/* {TYPE}.is_attached */
EIF_BOOLEAN F748_5296 (EIF_REFERENCE Current)
{
	GTCX
...
/* {TYPE}.is_equal */
EIF_BOOLEAN F748_5297 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
...
/* {TYPE}.default */
EIF_NATURAL_64* F748_5304 (EIF_REFERENCE Current)
{
	GTCX
...
/* {TYPE}.out */
EIF_REFERENCE F748_5305 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
...
/* {TYPE}.runtime_name */
EIF_REFERENCE F748_5316 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("runtime_name", 747, Current, 0, 0, 10149);
