...
/* {TYPE}.name */
EIF_REFERENCE F763_5288 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_REFERENCE F763_5289 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("generic_parameter_type", 762, Current, 0, 1, 10392);
...
/* {TYPE}.type_id */
EIF_INTEGER_32 F763_5290 (EIF_REFERENCE Current)
{
	GTCX
...
/* {TYPE}.hash_code */
EIF_INTEGER_32 F763_5291 (EIF_REFERENCE Current)
{
	GTCX
...
/* {TYPE}.is_attached */
EIF_BOOLEAN F763_5296 (EIF_REFERENCE Current)
{
	GTCX
...
/* {TYPE}.is_equal */
EIF_BOOLEAN F763_5297 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
...
/* {TYPE}.default */
EIF_REFERENCE F763_5304 (EIF_REFERENCE Current)
{
	GTCX
	struct eif_ex_215 sloc1;
...
/* {TYPE}.out */
EIF_REFERENCE F763_5305 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
...
/* {TYPE}.runtime_name */
EIF_REFERENCE F763_5316 (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
	...
	RTEAA("runtime_name", 762, Current, 0, 0, 10419);
