...
EIF_BOOLEAN F673_4360 (EIF_REFERENCE Current)
{
	GTCX
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		RTLE;
		return (EIF_BOOLEAN) F653_4343(Current);
	} else {
		Result = '\01';
...
void F673_4362 (EIF_REFERENCE Current)
{
	GTCX
	...
	if ((EIF_BOOLEAN) !*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		...
		for (;;) {
			...
			tr1 = *(EIF_REFERENCE *)(loc2 + O1722[Dtype(loc2)-104]);
			RTAR(Current, tr1);
...
EIF_REFERENCE F673_4363 (EIF_REFERENCE Current)
{
