...
feature -- model operations
	...
	setup_chess(p: CHESS; row: INTEGER; col: INTEGER)
		require
			valid_game_mode:
				game_mode = 1
...
feature -- queries
	...
	is_move_possible(r1: INTEGER ; c1: INTEGER ; r2: INTEGER ; c2: INTEGER): BOOLEAN
		local
			...
			j: INTEGER
		do
			arr := (board.get (r1, c1).return_possible_moves (r1, c1))
			from j := arr.lower
