...
extern EIF_TYPED_VALUE F1526_15480(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1526_15481(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1526_15482(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1526_15483(EIF_REFERENCE);
...
RTOID (F1526_15480)
EIF_TYPED_VALUE F1526_15480 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1525, Current, 0, 0, 21565);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1525, Current, 21565);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(11497, "is_current_file_system", Result))(Result)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
RTOID (F1526_15481)
EIF_TYPED_VALUE F1526_15481 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1525, Current, 0, 0, 21566);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1525, Current, 21566);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000605, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1541, 0x01).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11496, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
RTOID (F1526_15482)
EIF_TYPED_VALUE F1526_15482 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1525, Current, 0, 0, 21567);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1525, Current, 21567);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000605, 0,0); /* Result */
...
RTOID (F1526_15483)
EIF_TYPED_VALUE F1526_15483 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1525, Current, 0, 0, 21568);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1525, Current, 21568);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (15480,F1526_15480)
	RTOTS (15481,F1526_15481)
	RTOTS (15482,F1526_15482)
	RTOTS (15483,F1526_15483)
}
