...
extern EIF_TYPED_VALUE F1520_15296(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1520_15296 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1519, Current, 0, 0, 21417);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1519, Current, 21417);
	RTIV(Current, RTAL);
	RTHOOK(1);
