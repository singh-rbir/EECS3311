...
extern void F1530_15562(EIF_REFERENCE);
extern void F1530_15563(EIF_REFERENCE);
...
void F1530_15562 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1529, Current, 0, 0, 21628);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1529, Current, 21628);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1530_15563 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1529, Current, 0, 0, 21629);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1529, Current, 21629);
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(11397, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
