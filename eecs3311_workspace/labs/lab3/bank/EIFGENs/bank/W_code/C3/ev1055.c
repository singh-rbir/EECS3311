...
static EIF_TYPED_VALUE F1055_9160_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1055_9160(EIF_REFERENCE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1054, Current, 1, 0, 15438);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1054, Current, 15438);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		ur1 = RTCCL(Result);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6927, dtype))(Current, ur1x);
		RTHOOK(5);
		RTDBGAA(Current, dtype, 6926, 0xF800047D, 0); /* expose_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1055_9160_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1054, Current, 0, 0, 15439);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1054, Current, 15439);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1055_9160 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(6926,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(6926, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1055_9160_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(6926,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1054, Current, 0, 1, 15440);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1054, Current, 15440);
	RTCC(arg1, 1054, l_feature_name, 1, RTWCT(6925, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
