...
#define ub1 ub1x.it_b
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,332,0xFF01,1045,0xFFFF};
		EIF_TYPE typres0;
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6798, 0xF800014C, 0); /* test_classes */
	tr1 = RTCCL(arg3);
	RTAR(Current, tr1);
	...
	for (;;) {
		...
		if (EIF_TEST(loc3)) {
			...
			for (;;) {
				...
				RTHOOK(16);
				tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7190, "is_violation_case", loc4))(loc4)).it_b);
				if (tb3) {
					RTHOOK(17);
					tb3 = *(EIF_BOOLEAN *)(loc4 + RTVA(7193, "passed", loc4));
					if (tb3) {
						RTHOOK(18);
						RTDBGAA(Current, dtype, 6793, 0x10000000, 1); /* number_passed_violation */
