...
extern EIF_TYPED_VALUE F998_8597(EIF_REFERENCE);
extern EIF_TYPED_VALUE F998_8598(EIF_REFERENCE);
...
RTOID (F998_8597)
EIF_TYPED_VALUE F998_8597 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 14938);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 14938);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	tr2 = RTMS_EX_H("",0,0);
	ur1 = tr2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(8114, Dtype(tr1)))(tr1, ur1x);
	RTNHOOK(1,1);
...
RTOID (F998_8598)
EIF_TYPED_VALUE F998_8598 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 14939);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 14939);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800048C, 0,0); /* Result */
...
{
	GTCX
	RTOTS (8597,F998_8597)
	RTOTS (8598,F998_8598)
}
