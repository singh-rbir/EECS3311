...
extern void F1584_12996(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1584_12997(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1584_12998(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1584_13001(EIF_REFERENCE);
static EIF_TYPED_VALUE F1584_13002_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1584_13002(EIF_REFERENCE);
...
void F1584_12996 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1583, Current, 0, 0, 19531);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1583, Current, 19531);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9943, 0xF8000155, 0); /* child_array */
	tr1 = RTLNSMART(RTWCT(9943, dtype, Dftype(Current)).id);
	ui4_1 = ((EIF_INTEGER_32) 0L);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(3081, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,1);
	tr1 = RTCCL(tr1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(9943, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	ub1 = (EIF_BOOLEAN) 1;
...
EIF_TYPED_VALUE F1584_12997 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1583, Current, 0, 1, 19532);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1583, Current, 19532);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1584_12998 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1583, Current, 0, 0, 19533);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1583, Current, 19533);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1584_13001 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(9943,Dtype(Current)));
	return r;
}


/* {EV_DYNAMIC_LIST_IMP}.interface */
static EIF_TYPED_VALUE F1584_13002_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1583, Current, 0, 0, 19535);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1583, Current, 19535);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1584_13002 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9318, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1584_13002_body (Current)).it_r;
