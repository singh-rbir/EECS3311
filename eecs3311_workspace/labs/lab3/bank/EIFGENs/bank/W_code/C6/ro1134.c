...
extern EIF_TYPED_VALUE F1134_10065(EIF_REFERENCE);
extern void F1134_10066(EIF_REFERENCE);
extern void F1134_16422(EIF_REFERENCE, int);
...
/* {ROOT}.switch */
EIF_TYPED_VALUE F1134_10065 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1133, Current, 0, 0, 16297);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1133, Current, 16297);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ROOT}.add_tests */
void F1134_10066 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1133, Current, 0, 0, 16298);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1133, Current, 16298);
	RTIV(Current, RTAL);
...
/* {ROOT}._invariant */
void F1134_16422 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1133, Current, 0, 16421);
	RTSA(dtype);
	RTME(dtype, 0);
