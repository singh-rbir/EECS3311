...
extern EIF_TYPED_VALUE F1156_10179(EIF_REFERENCE);
...
RTOID (F1156_10179)
EIF_TYPED_VALUE F1156_10179 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1155, Current, 0, 0, 16729);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1155, Current, 16729);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF80004A4, 0,0); /* Result */
