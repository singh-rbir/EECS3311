...
extern EIF_TYPED_VALUE F1368_13024(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1368_13025(EIF_REFERENCE);
static EIF_TYPED_VALUE F1368_13031_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1368_13031(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1368_13024 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1367, Current, 1, 0, 19555);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1367, Current, 19555);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1368_13025 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1367, Current, 1, 0, 19556);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1367, Current, 19556);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(1, 0xF80004DA, 0, 0); /* loc1 */
...
static EIF_TYPED_VALUE F1368_13031_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1367, Current, 0, 0, 19557);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1367, Current, 19557);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1368_13031 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9318, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1368_13031_body (Current)).it_r;
