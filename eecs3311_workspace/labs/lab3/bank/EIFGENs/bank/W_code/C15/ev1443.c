...
extern EIF_TYPED_VALUE F1443_13968(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1443_13969(EIF_REFERENCE);
extern void F1443_13977(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1443_13978_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1443_13978(EIF_REFERENCE);
extern void F1443_16491(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1443_13968 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(10561,Dtype(Current)));
	return r;
}


/* {EV_GAUGE_I}.proportion */
EIF_TYPED_VALUE F1443_13969 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1442, Current, 2, 0, 20274);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1443_13977 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1442, Current, 2, 1, 20275);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
static EIF_TYPED_VALUE F1443_13978_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1442, Current, 0, 0, 20276);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1442, Current, 20276);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1443_13978 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9318, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1443_13978_body (Current)).it_r;
...
void F1443_16491 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1442, Current, 0, 16490);
	RTSA(dtype);
	RTME(dtype, 0);
