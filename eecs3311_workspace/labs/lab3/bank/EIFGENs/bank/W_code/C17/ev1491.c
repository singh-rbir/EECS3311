...
extern void F1491_14732(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1491_14733(EIF_REFERENCE);
extern void F1491_14734(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1491_14735(EIF_REFERENCE);
extern void F1491_14736(EIF_REFERENCE);
extern void F1491_14737(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1491_14738(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1491_14739(EIF_REFERENCE);
static EIF_TYPED_VALUE F1491_14740_body(EIF_REFERENCE);
...
void F1491_14732 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1490, Current, 0, 1, 20930);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1490, Current, 20930);
	RTCC(arg1, 1490, l_feature_name, 1, RTWCT(9318, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1491_14733 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1490, Current, 0, 0, 20931);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1490, Current, 20931);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5877, 970))(Current)).it_p);
	up1 = tp1;
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1490, Current, 0, 0, 20932);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1490, Current, 20932);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1490, Current, 0, 0, 20933);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1490, Current, 20933);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1491_14736 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1490, Current, 0, 0, 20934);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1490, Current, 20934);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(3);
		RTDBGAA(Current, dtype, 10888, 0x04000000, 1); /* ignore_select_actions */
...
void F1491_14737 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1490, Current, 0, 0, 20935);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1490, Current, 20935);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_selectable", EX_PRE);
...
EIF_TYPED_VALUE F1491_14738 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1490, Current, 0, 0, 20936);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1490, Current, 20936);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	...
	if ((EIF_BOOLEAN)(tr1 != NULL)) {
		tb2 = *(EIF_BOOLEAN *)(Current + RTWA(10888, dtype));
		tb1 = (EIF_BOOLEAN) !tb2;
	}
	Result = (EIF_BOOLEAN) tb1;
	RTVI(Current, RTAL);
...
static EIF_TYPED_VALUE F1491_14740_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1490, Current, 0, 0, 20938);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1490, Current, 20938);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1491_14740 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9318, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1491_14740_body (Current)).it_r;
