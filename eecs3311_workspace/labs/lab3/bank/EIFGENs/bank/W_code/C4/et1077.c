...
extern void F1077_9367(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1077_9368(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1077_9369(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1077_9370(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1077_9371(EIF_REFERENCE);
...
/* {ETF_ENUM_PARAM}.make */
void F1077_9367 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1076, Current, 0, 1, 15622);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1076, Current, 15622);
	{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7122, 0xF8000154, 0); /* items */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F1077_9368 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1077_9369 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1076, Current, 0, 0, 15624);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1076, Current, 15624);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1077_9370 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1076, Current, 1, 0, 15625);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1076, Current, 15625);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80000E8, 0,0); /* Result */
...
/* {ETF_ENUM_PARAM}.out */
EIF_TYPED_VALUE F1077_9371 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1076, Current, 1, 0, 15626);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1076, Current, 15626);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80000E8, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(232, 0x01).id);
