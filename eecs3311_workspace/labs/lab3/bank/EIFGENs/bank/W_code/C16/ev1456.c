...
extern EIF_TYPED_VALUE F1456_14074(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1456_14075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1456_14079(EIF_REFERENCE);
extern void F1456_14091(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1456_14092(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1456_14093(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1456_14094(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1456_14095(EIF_REFERENCE);
static EIF_TYPED_VALUE F1456_14106_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1456_14106(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1456_14074 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(10652,Dtype(Current)));
	return r;
}


/* {EV_RICH_TEXT_I}.buffer_locked_in_append_mode */
EIF_TYPED_VALUE F1456_14075 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(10653,Dtype(Current)));
	return r;
}


/* {EV_RICH_TEXT_I}.tab_positions */
EIF_TYPED_VALUE F1456_14079 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(10657,Dtype(Current)));
	return r;
}


/* {EV_RICH_TEXT_I}.save_to_named_path */
void F1456_14091 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1455, Current, 15, 1, 20312);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1455, Current, 20312);
	RTCC(arg1, 1455, l_feature_name, 1, eif_new_type(185, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(2);
	RTDBGAL(9, 0xF8000601, 0, 0); /* loc9 */
	tr7 = RTLN(eif_new_type(1537, 0x01).id);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(11411, Dtype(tr7)))(tr7, ur1x);
	RTNHOOK(2,1);
	...
	RTHOOK(5);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(10678, dtype))(Current);
	RTHOOK(6);
	ur1 = RTCCL(loc7);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(11417, "generate_paragraph_information", loc9))(loc9, ur1x);
	RTHOOK(7);
	RTDBGAL(11, 0xF800022D, 0, 0); /* loc11 */
	tr7 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(11465, "paragraph_start_indexes", loc9))(loc9)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc11 = (EIF_REFERENCE) RTCCL(tr7);
	RTHOOK(8);
	RTDBGAL(12, 0xF8000155, 0, 0); /* loc12 */
	tr7 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(11466, "paragraph_formats", loc9))(loc9)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	...
	RTHOOK(13);
	tr7 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(11416, "internal_text", loc9))(loc9)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(13,1);
	ui4_1 = loc2;
	...
	for (;;) {
		...
		ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(10672, dtype))(Current, ui4_1x, ui4_2x)).it_i4);
		...
		if ((EIF_BOOLEAN) ((EIF_BOOLEAN) (loc6 > loc5) && (EIF_BOOLEAN) !loc13)) {
			...
			if ((EIF_BOOLEAN)(loc5 != loc3)) {
				...
				ur1 = RTCCL(tr7);
				ur2 = RTCCL(loc8);
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(11414, "append_text_for_rtf", loc9))(loc9, ur1x, ur2x);
				RTHOOK(26);
				RTDBGAL(3, 0x10000000, 1, 0); /* loc3 */
	...
	RTHOOK(49);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(11420, "generate_complete_rtf_from_buffering", loc9))(loc9);
	RTHOOK(50);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(10679, dtype))(Current);
	RTHOOK(51);
	...
	if (RTAL & CK_ENSURE) {
		...
		tb4 = '\0';
		RTCO(tr4);
		tb5 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10603, dtype))(Current)).it_b);
...
void F1456_14092 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1455, Current, 3, 1, 20313);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1455, Current, 20313);
	RTCC(arg1, 1455, l_feature_name, 1, eif_new_type(185, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	if (RTAL & CK_ENSURE) {
		...
		RTNHOOK(1,1);
		tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10105, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		ur1 = RTCCL(tr2);
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(10680, dtype))(Current);
	RTHOOK(3);
	...
	RTHOOK(9);
	RTDBGAL(3, 0xF8000601, 0, 0); /* loc3 */
	tr6 = RTLN(eif_new_type(1537, 0x01).id);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(11411, Dtype(tr6)))(tr6, ur1x);
	RTNHOOK(9,1);
	loc3 = (EIF_REFERENCE) RTCCL(tr6);
	RTHOOK(10);
	ur1 = RTCCL(loc2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(11418, "set_with_rtf", loc3))(loc3, ur1x);
	RTHOOK(11);
	RTDBGAA(Current, dtype, 10671, 0x04000000, 1); /* last_load_successful */
	tb3 = *(EIF_BOOLEAN *)(loc3 + RTVA(11419, "last_load_successful", loc3));
	*(EIF_BOOLEAN *)(Current + RTWA(10671, dtype)) = (EIF_BOOLEAN) tb3;
	RTHOOK(12);
	...
	if (RTAL & CK_ENSURE) {
		...
		tb3 = '\01';
		tb4 = *(EIF_BOOLEAN *)(Current + RTWA(10671, dtype));
		if (tb4) {
			ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10602, dtype))(Current)).it_i4);
		...
		if ((EIF_BOOLEAN) !tb4) {
			...
			tb5 = '\0';
			RTCO(tr3);
			tb6 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10603, dtype))(Current)).it_b);
...
EIF_TYPED_VALUE F1456_14093 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F1456_14094 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1455, Current, 5, 2, 20315);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1455, Current, 20315);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	RTHOOK(4);
	RTDBGAL(3, 0x10000000, 1, 0); /* loc3 */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10673, dtype))(Current)).it_i4);
	...
	for (;;) {
		...
		if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (loc1 + loc3) <= arg2)) {
			...
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(10674, dtype))(Current, ui4_1x, ui4_2x)).it_b);
			tb2 = tb3;
		}
		if (tb2) {
			RTHOOK(9);
...
EIF_TYPED_VALUE F1456_14095 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
static EIF_TYPED_VALUE F1456_14106_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1455, Current, 0, 0, 20309);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1455, Current, 20309);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1456_14106 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9318, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1456_14106_body (Current)).it_r;
