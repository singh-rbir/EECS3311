...
static EIF_TYPED_VALUE F1463_14286_body(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1463_14286_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1463_14286 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9318, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1463_14286_body (Current)).it_r;
