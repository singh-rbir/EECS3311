...
extern EIF_TYPED_VALUE F981_8516(EIF_REFERENCE);
extern void F981_16410(EIF_REFERENCE, int);
...
/* {ETF_MODEL_ACCESS}.m */
RTOID (F981_8516)
EIF_TYPED_VALUE F981_8516 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 980, Current, 0, 0, 14858);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(980, Current, 14858);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F981_16410 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 980, Current, 0, 16409);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
