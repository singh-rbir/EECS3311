...
extern void F984_8527(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F984_8525 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(6312,Dtype(Current)));
	return r;
}
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 983, Current, 1, 0, 14868);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6312, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
void F984_8527 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 983, Current, 2, 1, 14869);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6312, 0xF8000100, 0); /* items */
	{
	...
	tr1 = RTCCL(tr1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(6312, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6311, 0xF80000E8, 0); /* error_string */
	tr1 = RTLNSMART(RTWCT(6311, dtype, Dftype(Current)).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(4643, Dtype(tr1)))(tr1);
	RTNHOOK(2,1);
	tr1 = RTCCL(tr1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(6311, dtype)) = (EIF_REFERENCE) tr1;
	...
	RTHOOK(4);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3549, "exists", loc1))(loc1)).it_b);
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 6310, 0x04000000, 1); /* error */
		*(EIF_BOOLEAN *)(Current + RTWA(6310, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		RTHOOK(6);
		RTDBGAA(Current, dtype, 6311, 0xF80000E8, 0); /* error_string */
		...
		*(EIF_REFERENCE *)(Current + RTWA(6311, dtype)) = (EIF_REFERENCE) tr1;
		...
		RTHOOK(7);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3552, "is_readable", loc1))(loc1)).it_b);
		if ((EIF_BOOLEAN) !tb1) {
			RTHOOK(8);
			RTDBGAA(Current, dtype, 6310, 0x04000000, 1); /* error */
			*(EIF_BOOLEAN *)(Current + RTWA(6310, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
			...
			*(EIF_REFERENCE *)(Current + RTWA(6311, dtype)) = (EIF_REFERENCE) tr1;
			...
			for (;;) {
				RTHOOK(11);
				tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3555, "readable", loc1))(loc1)).it_b);
				if ((EIF_BOOLEAN) !tb1) break;
				RTHOOK(12);
				(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(3604, "read_line", loc1))(loc1);
				RTHOOK(13);
				RTDBGAL(2, 0xF80000E8, 0, 0); /* loc2 */
				tr1 = RTLN(eif_new_type(232, 0x01).id);
				tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3535, "last_string", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				ur1 = RTCCL(tr2);
	...
	if (RTAL & CK_ENSURE) {
		...
		tb2 = '\01';
		tb3 = *(EIF_BOOLEAN *)(Current + RTWA(6310, dtype));
		if (tb3) {
			tb3 = '\0';
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6312, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(16,1);
			...
			if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 0L))) {
				tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6311, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				RTNHOOK(16,2);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 983, Current, 1, 0, 14870);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	for (;;) {
		...
		loc1 = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(4794, "left_adjust", loc1))(loc1);
		RTHOOK(5);
		tb2 = '\01';
		tr1 = RTMS_EX_H("--",2,11565);
		ur1 = tr1;
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4757, "starts_with", loc1))(loc1, ur1x)).it_b);
		if (!tb3) {
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4660, "is_whitespace", loc1))(loc1)).it_b);
			tb2 = tb3;
		}
		if (tb2) {
			RTHOOK(6);
