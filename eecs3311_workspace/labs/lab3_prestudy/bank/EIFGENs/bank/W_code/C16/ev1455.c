...
extern EIF_TYPED_VALUE F1455_14061(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1455_14064(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1455_14065_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1455_14065(EIF_REFERENCE);
...
/* {EV_TEXT_I}.search */
EIF_TYPED_VALUE F1455_14061 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1454, Current, 0, 2, 20305);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1454, Current, 20305);
	RTCC(arg1, 1454, l_feature_name, 1, eif_new_type(229, 0x01), 0x01);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1455_14064 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1454, Current, 0, 1, 20306);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1454, Current, 20306);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_TEXT_I}.interface */
static EIF_TYPED_VALUE F1455_14065_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1454, Current, 0, 0, 20307);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1455_14065 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9318, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1455_14065_body (Current)).it_r;
