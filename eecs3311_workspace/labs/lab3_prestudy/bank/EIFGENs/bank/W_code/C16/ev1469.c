...
extern void F1469_14373(EIF_REFERENCE);
extern void F1469_14375(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1469_14376(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1469_14378(EIF_REFERENCE);
static EIF_TYPED_VALUE F1469_14379_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1469_14379(EIF_REFERENCE);
...
void F1469_14373 (EIF_REFERENCE Current)
{
	GTCX
...
void F1469_14375 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1468, Current, 0, 1, 20582);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1468, Current, 20582);
	RTIV(Current, RTAL);
...
body:;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10254, dtype))(Current, ui4_1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
EIF_TYPED_VALUE F1469_14376 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1468, Current, 0, 0, 20583);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTAOMS(14375,1);
	RTDBGEAA(1468, Current, 20583);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	RTCOMS(tr2,14375,0,"W",1,87);
	ur1 = tr2;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(8525, "string_width", tr1))(tr1, ur1x)).it_i4);
...
EIF_TYPED_VALUE F1469_14378 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1468, Current, 0, 0, 20584);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1468, Current, 20584);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1469_14379_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1468, Current, 0, 0, 20585);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1468, Current, 20585);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1469_14379 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9318, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1469_14379_body (Current)).it_r;
