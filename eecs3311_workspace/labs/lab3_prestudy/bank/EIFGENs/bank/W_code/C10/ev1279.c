...
extern EIF_TYPED_VALUE F1279_11585(EIF_REFERENCE);
extern void F1279_11586(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1279_11585 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1279_11586 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1278, Current, 0, 0, 18270);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1278, Current, 18270);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8389, 0xF800058A, 0); /* implementation */
