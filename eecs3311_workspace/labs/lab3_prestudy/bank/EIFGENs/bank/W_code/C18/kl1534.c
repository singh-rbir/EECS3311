...
extern EIF_TYPED_VALUE F1534_15588(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1534_15589(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1534_15590(EIF_REFERENCE);
extern void F1534_15591(EIF_REFERENCE);
extern void F1534_15592(EIF_REFERENCE);
extern void F1534_15593(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1534_15588 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1534_15589 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1534_15590 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1534_15590,21652,RTMS_EX_H("\012",1,10));
}

/* {KL_TEXT_INPUT_FILE}.read_line */
void F1534_15591 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1533, Current, 5, 0, 21652);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1533, Current, 21652);
	RTIV(Current, RTAL);
...
body:;
	...
	RTNHOOK(3,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(11409, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur1 = RTCCL(tr2);
	...
	for (;;) {
		...
		RTHOOK(8);
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(11408, dtype));
		if (tb1) {
			RTHOOK(9);
	...
	*(EIF_BOOLEAN *)(Current + RTWA(11408, dtype)) = (EIF_BOOLEAN) loc4;
	if (RTAL & CK_ENSURE) {
		RTHOOK(20);
...
void F1534_15592 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1533, Current, 0, 0, 21653);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1533, Current, 21653);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
...
void F1534_15593 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1533, Current, 0, 0, 21648);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1533, Current, 21648);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
