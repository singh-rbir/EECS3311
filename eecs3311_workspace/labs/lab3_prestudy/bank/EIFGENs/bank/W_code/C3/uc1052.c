...
extern EIF_TYPED_VALUE F1052_9107(EIF_REFERENCE);
...
RTOID (F1052_9107)
EIF_TYPED_VALUE F1052_9107 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1051, Current, 0, 0, 15385);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1051, Current, 15385);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
