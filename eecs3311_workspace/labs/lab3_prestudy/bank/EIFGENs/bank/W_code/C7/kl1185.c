...
extern EIF_TYPED_VALUE F1185_10422(EIF_REFERENCE);
...
RTOID (F1185_10422)
EIF_TYPED_VALUE F1185_10422 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1184, Current, 0, 0, 17035);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1184, Current, 17035);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
