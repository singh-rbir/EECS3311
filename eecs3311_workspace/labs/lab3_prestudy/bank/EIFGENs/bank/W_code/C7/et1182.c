...
extern void F1182_10371(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ETF_NEW}.new */
void F1182_10371 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
	char *l_feature_name = "new";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1181, Current, 0, 1, 16932);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1181, Current, 16932);
