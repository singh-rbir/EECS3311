...
extern void F1405_13327(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1405_13328(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1405_13329(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1405_13330(EIF_REFERENCE);
extern void F1405_13331(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1405_13332_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1405_13332(EIF_REFERENCE);
extern void EIF_Minit1405(void);
extern EIF_REFERENCE _A1206_335();
extern EIF_REFERENCE _A1206_334();
...
void F1405_13327 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1404, Current, 0, 1, 19773);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1404, Current, 19773);
	RTCC(arg1, 1404, l_feature_name, 1, RTWCT(9318, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1405_13328 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1404, Current, 3, 0, 19774);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1404, Current, 19774);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up2 = tp2;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5293, 969))(Current)).it_i4);
	ui4_1 = ti4_1;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1206_334, (EIF_POINTER)(0),8176, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1206_335, (EIF_POINTER)(0),8177, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(9839, dtype))(Current, up1x, ur1x, ur2x, ur3x);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1404, Current, 2, 0, 19775);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1404, Current, 19775);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10152, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc2 = tr1;
	if (EIF_TEST(loc2)) {
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10130, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = tr1;
...
void F1405_13331 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1404, Current, 1, 1, 19771);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1404, Current, 19771);
	RTCC(arg1, 1404, l_feature_name, 1, eif_new_type(185, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10164, 0xF80000B9, 0); /* start_path */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(10164, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	...
	if (RTAL & CK_ENSURE) {
		...
		tr1 = *(EIF_REFERENCE *)(Current + RTWA(10164, dtype));
		if (RTEQ(tr1, arg1)) {
			RTCK;
		} else {
			RTCF;
...
static EIF_TYPED_VALUE F1405_13332_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1404, Current, 0, 0, 19772);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1404, Current, 19772);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1405_13332 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9318, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1405_13332_body (Current)).it_r;
