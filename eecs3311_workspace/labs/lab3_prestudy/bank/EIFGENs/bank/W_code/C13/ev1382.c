...
extern EIF_TYPED_VALUE F1382_13176(EIF_REFERENCE);
extern void F1382_13177(EIF_REFERENCE);
extern void F1382_13178(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1382_13180(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1382_13182(EIF_REFERENCE);
static EIF_TYPED_VALUE F1382_13183_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1382_13183(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1382_13176 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1381, Current, 0, 0, 19662);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1381, Current, 19662);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10078, dtype))(Current)).it_p);
		up1 = tp1;
...
void F1382_13177 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1381, Current, 0, 0, 19663);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1381, Current, 19663);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10078, dtype))(Current)).it_p);
	up1 = tp1;
...
void F1382_13178 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1381, Current, 0, 0, 19664);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1381, Current, 19664);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10078, dtype))(Current)).it_p);
	up1 = tp1;
...
EIF_TYPED_VALUE F1382_13180 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1381, Current, 0, 0, 19665);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1382_13182 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1381, Current, 1, 0, 19666);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
static EIF_TYPED_VALUE F1382_13183_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1381, Current, 0, 0, 19667);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1381, Current, 19667);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1382_13183 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9318, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1382_13183_body (Current)).it_r;
