...
extern void F989_7633(EIF_REFERENCE);
...
/* {ROOT}.make */
void F989_7633 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 988, Current, 0, 0, 13892);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(988, Current, 13892);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(5153, Dtype(tr1)))(tr1);
	RTNHOOK(2,1);
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5117, dtype))(Current, ur1x);
	RTHOOK(3);
