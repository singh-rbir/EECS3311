...
extern void F968_7337(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F968_7341(EIF_REFERENCE);
extern EIF_TYPED_VALUE F968_7342(EIF_REFERENCE);
extern void F968_7343(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F968_7344(EIF_REFERENCE);
extern void F968_7345(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F968_7346(EIF_REFERENCE);
extern EIF_TYPED_VALUE F968_7347(EIF_REFERENCE);
...
/* {ES_SUITE}.add_test */
void F968_7337 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 967, Current, 1, 1, 13624);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	if ((EIF_BOOLEAN) !(EIF_BOOLEAN)(loc1 != NULL)) {
		...
		loc1 = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(5);
		RTDBGAA(Current, dtype, 5124, 0xF800014C, 0); /* classes */
		tr1 = RTCCL(loc1);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(5124, dtype)) = (EIF_REFERENCE) tr1;
		RTHOOK(6);
		RTDBGAA(Current, dtype, 5123, 0xF80000E8, 0); /* name */
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 967, Current, 2, 1, 13625);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(967, Current, 13625);
	RTCC(arg1, 967, l_feature_name, 1, eif_new_type(967, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5124, "classes", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc1 = RTCCL(tr1);
	if (EIF_TEST(loc1)) {
		RTHOOK(3);
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 967, Current, 3, 1, 13626);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	RTHOOK(4);
	RTDBGAL(1, 0xF80003C5, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(965, 0x01).id);
	ur1 = RTCCL(loc3);
	ur2 = RTCCL(arg1);
	ur3 = RTCCL(loc2);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(5115, dtype));
	ub1 = tb1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(5095, Dtype(tr1)))(tr1, ur1x, ur2x, ur3x, ub1x);
	RTNHOOK(4,1);
	loc1 = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 967, Current, 2, 0, 13627);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 5113, 0x10000000, 1); /* number_of_tests */
		*(EIF_INTEGER_32 *)(Current + RTWA(5113, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
		RTHOOK(3);
		RTDBGAA(Current, dtype, 5114, 0x10000000, 1); /* number_passed_tests */
		*(EIF_INTEGER_32 *)(Current + RTWA(5114, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
		RTHOOK(4);
		...
		for (;;) {
			...
			RTHOOK(7);
			tb2 = *(EIF_BOOLEAN *)(Current + RTWA(5115, dtype));
			if (tb2) {
				RTHOOK(8);
				tb2 = *(EIF_BOOLEAN *)(Current + RTWA(5115, dtype));
				ub1 = tb2;
				(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5102, "set_error_report", loc2))(loc2, ub1x);
			}
			RTHOOK(9);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5103, "run_es_test", loc2))(loc2);
			RTHOOK(10);
			RTDBGAA(Current, dtype, 5113, 0x10000000, 1); /* number_of_tests */
			ti4_2 = *(EIF_INTEGER_32 *)(loc2 + RTVA(5113, "number_of_tests", loc2));
			(*(EIF_INTEGER_32 *)(Current + RTWA(5113, dtype))) += ti4_2;
			RTHOOK(11);
			RTDBGAA(Current, dtype, 5114, 0x10000000, 1); /* number_passed_tests */
			ti4_2 = *(EIF_INTEGER_32 *)(loc2 + RTVA(5114, "number_passed_tests", loc2));
			(*(EIF_INTEGER_32 *)(Current + RTWA(5114, dtype))) += ti4_2;
			RTHOOK(12);
...
EIF_TYPED_VALUE F968_7341 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 967, Current, 2, 0, 13628);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		for (;;) {
			...
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3145, "item", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(4,1);
			tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5109, "passed_cases", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F968_7342 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 967, Current, 2, 0, 13629);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		for (;;) {
			...
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3145, "item", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(4,1);
			tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5110, "failed_cases", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ur1 = RTCCL(tr2);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2492, "append", Result))(Result, ur1x);
			RTHOOK(5);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(3147, "forth", loc2))(loc2);
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 967, Current, 0, 1, 13630);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5115, 0x04000000, 1); /* show_err */
	*(EIF_BOOLEAN *)(Current + RTWA(5115, dtype)) = (EIF_BOOLEAN) arg1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5123, 0xF80000E8, 0); /* name */
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 967, Current, 1, 0, 13631);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F968_7345 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_r
	...
	RTEAA(l_feature_name, 967, Current, 0, 3, 13632);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(967, Current, 13632);
	RTCC(arg3, 967, l_feature_name, 3, RTWCT(5123, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5115, 0x04000000, 1); /* show_err */
	*(EIF_BOOLEAN *)(Current + RTWA(5115, dtype)) = (EIF_BOOLEAN) arg1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5116, 0x04000000, 1); /* browser */
	*(EIF_BOOLEAN *)(Current + RTWA(5116, dtype)) = (EIF_BOOLEAN) arg2;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5123, 0xF80000E8, 0); /* name */
	tr1 = RTCCL(arg3);
	RTAR(Current, tr1);
...
/* {ES_SUITE}.classes */
EIF_TYPED_VALUE F968_7347 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
