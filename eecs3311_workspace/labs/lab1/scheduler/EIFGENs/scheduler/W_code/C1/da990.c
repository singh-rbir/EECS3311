...
extern void F990_7634(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F990_7635(EIF_REFERENCE);
extern EIF_TYPED_VALUE F990_7636(EIF_REFERENCE);
extern EIF_TYPED_VALUE F990_7637(EIF_REFERENCE);
extern void F990_7638(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F990_7639(EIF_REFERENCE);
...
/* {DATE_TIME_CODE}.make */
void F990_7634 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 989, Current, 0, 1, 13896);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(989, Current, 13896);
...
body:;
	RTHOOK(3);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5352, dtype))(Current, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F990_7635 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 989, Current, 0, 0, 13897);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(989, Current, 13897);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F990_7636 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(5350,Dtype(Current)));
	return r;
}
...
void F990_7638 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 989, Current, 1, 1, 13900);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(989, Current, 13900);
	RTCC(arg1, 989, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5353, 0xF80000E8, 0); /* value */
	...
	*(EIF_REFERENCE *)(Current + RTWA(5353, dtype)) = (EIF_REFERENCE) tr1;
	...
	if (tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 5354, 0x10000000, 1); /* count_max */
		*(EIF_INTEGER_32 *)(Current + RTWA(5354, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
		RTHOOK(6);
		RTDBGAA(Current, dtype, 5355, 0x10000000, 1); /* count_min */
		*(EIF_INTEGER_32 *)(Current + RTWA(5355, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		...
		RTHOOK(8);
		RTDBGAA(Current, dtype, 5357, 0x10000000, 1); /* value_max */
		*(EIF_INTEGER_32 *)(Current + RTWA(5357, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 31L);
		RTHOOK(9);
		RTDBGAA(Current, dtype, 5358, 0x10000000, 1); /* value_min */
		*(EIF_INTEGER_32 *)(Current + RTWA(5358, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		RTHOOK(10);
		RTDBGAA(Current, dtype, 5350, 0x04000000, 1); /* is_text */
		*(EIF_BOOLEAN *)(Current + RTWA(5350, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
		RTHOOK(11);
		RTDBGAA(Current, dtype, 5351, 0x04000000, 1); /* is_numeric */
		*(EIF_BOOLEAN *)(Current + RTWA(5351, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		RTHOOK(12);
		RTDBGAA(Current, dtype, 5359, 0x10000000, 1); /* type */
		...
		if (tb1) {
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(5359, dtype)) = (EIF_INTEGER_32) ti4_1;
			...
			if (tb1) {
				RTHOOK(23);
				RTDBGAA(Current, dtype, 5354, 0x10000000, 1); /* count_max */
				*(EIF_INTEGER_32 *)(Current + RTWA(5354, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
				RTHOOK(24);
				RTDBGAA(Current, dtype, 5355, 0x10000000, 1); /* count_min */
				*(EIF_INTEGER_32 *)(Current + RTWA(5355, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
				...
				RTHOOK(26);
				RTDBGAA(Current, dtype, 5357, 0x10000000, 1); /* value_max */
				*(EIF_INTEGER_32 *)(Current + RTWA(5357, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 7L);
				RTHOOK(27);
				RTDBGAA(Current, dtype, 5358, 0x10000000, 1); /* value_min */
				*(EIF_INTEGER_32 *)(Current + RTWA(5358, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
				RTHOOK(28);
				RTDBGAA(Current, dtype, 5350, 0x04000000, 1); /* is_text */
				*(EIF_BOOLEAN *)(Current + RTWA(5350, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
				RTHOOK(29);
				RTDBGAA(Current, dtype, 5351, 0x04000000, 1); /* is_numeric */
				...
				*(EIF_INTEGER_32 *)(Current + RTWA(5359, dtype)) = (EIF_INTEGER_32) ti4_1;
				...
				if (tb1) {
					RTHOOK(32);
					RTDBGAA(Current, dtype, 5354, 0x10000000, 1); /* count_max */
					*(EIF_INTEGER_32 *)(Current + RTWA(5354, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
					RTHOOK(33);
					RTDBGAA(Current, dtype, 5355, 0x10000000, 1); /* count_min */
					...
					*(EIF_INTEGER_32 *)(Current + RTWA(5359, dtype)) = (EIF_INTEGER_32) ti4_1;
					RTHOOK(38);
					RTDBGAA(Current, dtype, 5357, 0x10000000, 1); /* value_max */
					*(EIF_INTEGER_32 *)(Current + RTWA(5357, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
					RTHOOK(39);
					RTDBGAA(Current, dtype, 5358, 0x10000000, 1); /* value_min */
					*(EIF_INTEGER_32 *)(Current + RTWA(5358, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
				} else {
						...
						*(EIF_INTEGER_32 *)(Current + RTWA(5358, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
						...
						if (tb1) {
							...
							*(EIF_INTEGER_32 *)(Current + RTWA(5355, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
							...
							RTHOOK(53);
							RTDBGAA(Current, dtype, 5357, 0x10000000, 1); /* value_max */
							*(EIF_INTEGER_32 *)(Current + RTWA(5357, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 12L);
							RTHOOK(54);
							RTDBGAA(Current, dtype, 5358, 0x10000000, 1); /* value_min */
							*(EIF_INTEGER_32 *)(Current + RTWA(5358, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
							RTHOOK(55);
									...
									*(EIF_INTEGER_32 *)(Current + RTWA(5359, dtype)) = (EIF_INTEGER_32) ti4_1;
									...
									if (tb1) {
										...
										*(EIF_INTEGER_32 *)(Current + RTWA(5355, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
										...
										RTHOOK(80);
										RTDBGAA(Current, dtype, 5357, 0x10000000, 1); /* value_max */
										*(EIF_INTEGER_32 *)(Current + RTWA(5357, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 24L);
										RTHOOK(81);
										RTDBGAA(Current, dtype, 5358, 0x10000000, 1); /* value_min */
										*(EIF_INTEGER_32 *)(Current + RTWA(5358, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
										RTHOOK(82);
										RTDBGAA(Current, dtype, 5350, 0x04000000, 1); /* is_text */
										*(EIF_BOOLEAN *)(Current + RTWA(5350, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
										RTHOOK(83);
												...
												*(EIF_INTEGER_32 *)(Current + RTWA(5359, dtype)) = (EIF_INTEGER_32) ti4_1;
												...
												if (tb1) {
													...
													*(EIF_INTEGER_32 *)(Current + RTWA(5355, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
													...
													RTHOOK(107);
													RTDBGAA(Current, dtype, 5357, 0x10000000, 1); /* value_max */
													*(EIF_INTEGER_32 *)(Current + RTWA(5357, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 59L);
													RTHOOK(108);
													RTDBGAA(Current, dtype, 5358, 0x10000000, 1); /* value_min */
													*(EIF_INTEGER_32 *)(Current + RTWA(5358, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
													RTHOOK(109);
															...
															if (tb1) {
																...
																*(EIF_INTEGER_32 *)(Current + RTWA(5359, dtype)) = (EIF_INTEGER_32) ti4_1;
																...
																if (tb1) {
																	...
																	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5353, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
																	RTNHOOK(140,2);
																	...
																	*(EIF_INTEGER_32 *)(Current + RTWA(5354, dtype)) = (EIF_INTEGER_32) ti4_1;
																	RTHOOK(141);
																	RTDBGAA(Current, dtype, 5355, 0x10000000, 1); /* count_min */
																	*(EIF_INTEGER_32 *)(Current + RTWA(5355, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																	RTHOOK(142);
																	...
																	*(EIF_INTEGER_32 *)(Current + RTWA(5358, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
																	...
																	if (tb1) {
																		RTHOOK(149);
																		RTDBGAA(Current, dtype, 5354, 0x10000000, 1); /* count_max */
																		*(EIF_INTEGER_32 *)(Current + RTWA(5354, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																		RTHOOK(150);
																		RTDBGAA(Current, dtype, 5355, 0x10000000, 1); /* count_min */
																		*(EIF_INTEGER_32 *)(Current + RTWA(5355, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																		RTHOOK(151);
	...
	RTHOOK(206);
	RTDBGAA(Current, dtype, 5356, 0xF80000E8, 0); /* name */
	tr1 = RTCCL(loc1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5356, dtype)) = (EIF_REFERENCE) tr1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(207);
		RTCT("value_set", EX_POST);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5353, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
EIF_TYPED_VALUE F990_7639 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 989, Current, 0, 0, 13908);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(989, Current, 13908);
	RTIV(Current, RTAL);
	RTHOOK(1);
