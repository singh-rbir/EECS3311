...
void egc_init_plug (void)
{
	...
	egc_arrmake = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) F341_3307;
	egc_strset = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE)) F233_6779;
	egc_str32set = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE)) F239_6986;
	egc_routdisp_wb = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) F262_6486;
	...
	egc_system_name = "repository";
	egc_system_location = "/Users/rajanbirsingh/OneDrive - University of Manitoba/Raj_UofMdocx/EECS3311/eecs3311_workspace/labs/lab2/repository/EIFGENs/repository/W_code";
	egc_compiler_tag = 38;
	...
	egc_rlist[0] = "TEST_REPOSITORY.make";
	egc_rcdt[0] = 0;
	egc_rcrid[0] = 5103;
	egc_rcarg[0] = 0;
...
{
	if (egc_rcdt[0] == 0) {
		egc_rcdt[0] = 967; /* TEST_REPOSITORY */
	}
}
