...
extern EIF_TYPED_VALUE F978_7413(EIF_REFERENCE);
extern EIF_TYPED_VALUE F978_7414(EIF_REFERENCE);
extern EIF_TYPED_VALUE F978_7415(EIF_REFERENCE);
...
EIF_TYPED_VALUE F978_7413 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F978_7414 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F978_7415 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5143, "fractional_second", tr1));
