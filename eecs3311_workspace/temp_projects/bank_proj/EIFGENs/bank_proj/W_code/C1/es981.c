...
extern EIF_TYPED_VALUE F981_7455(EIF_REFERENCE);
extern EIF_TYPED_VALUE F981_7456(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 980, Current, 0, 1, 13718);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {ES_TEST_CASE}.passed */
EIF_TYPED_VALUE F981_7455 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F981_7456 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
